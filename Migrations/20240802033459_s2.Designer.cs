            ...
            modelBuilder.Entity("Core.database.Models.Authorized", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("e990cd85-5f78-4d38-9197-630b1078a0ec"),
            ...
            modelBuilder.Entity("Core.database.Models.Category", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedOn = new DateTime(2024, 8, 2, 10, 34, 58, 918, DateTimeKind.Local).AddTicks(5172),
                            Name = "Root"
                        },
                        new
                        {
                            ...
                            CreatedBy = new Guid("e3d1cf68-a04c-4ff8-89d8-40266246c86e"),
                            CreatedOn = new DateTime(2024, 8, 2, 10, 34, 58, 918, DateTimeKind.Local).AddTicks(5175),
                            Name = "Authorized",
                        ...
                        new
                        {
                            ...
                            CreatedBy = new Guid("e3d1cf68-a04c-4ff8-89d8-40266246c86e"),
                            CreatedOn = new DateTime(2024, 8, 2, 10, 34, 58, 918, DateTimeKind.Local).AddTicks(5178),
                            Name = "Nhóm quyền",
                        ...
                        new
                        {
                            ...
                            CreatedBy = new Guid("e3d1cf68-a04c-4ff8-89d8-40266246c86e"),
                            CreatedOn = new DateTime(2024, 8, 2, 10, 34, 58, 918, DateTimeKind.Local).AddTicks(5180),
                            Name = "Article",
                            ParentId = new Guid("2d6349ba-b2b6-49ce-8f9b-4531ec7372dd")
                        },
                        new
                        {
                            ...
                            CreatedBy = new Guid("e3d1cf68-a04c-4ff8-89d8-40266246c86e"),
                            CreatedOn = new DateTime(2024, 8, 2, 10, 34, 58, 918, DateTimeKind.Local).AddTicks(5183),
                            Name = "Product",
                            ParentId = new Guid("2d6349ba-b2b6-49ce-8f9b-4531ec7372dd")
                        });
                });
            ...
            modelBuilder.Entity("Core.database.Models.Member", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedOn = new DateTime(2024, 8, 2, 10, 34, 58, 918, DateTimeKind.Local).AddTicks(5142),
